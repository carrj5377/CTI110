...
# average in the list
# Part 2 of this homwork is to find the average for a student between 0 and 100
# Also find the letter grade on ten point scale (A, B, C, D, F)
...
# Letter grade based on ten point scale
if AVG >= 90:
